...
eventid2template = read_json(path_data + 'eventid2template.json')
fasttext_map = read_json(path_data + 'fasttext_map.json')
print(eventid2template)
dataset = list()
with open(path_data + '../HDFS_sequence_0.01/'+'hdfs_train_normal.csv', 'r') as f:
...
dump_2_json(word2idf, path_data + 'word2idf.json')
