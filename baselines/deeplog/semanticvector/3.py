...
event2template = read_json(path_data + 'eventid2template.json')
fasttext = read_json(path_data + 'fasttext_map.json')
word2idf = read_json(path_data + 'word2idf.json')
...
dump_2_json(event2semantic_vec,path_data + 'event2semantic_vec.json')
